...
public class Sendmail {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		driver.findElement(By.id("to")).sendKeys(fib.getExcelData("Exitletter", 1, 12));
		
		/*To enter email id in cc textbox*/
		driver.findElement(By.id("cc")).sendKeys(fib.getExcelData("Exitletter", 1, 13));
		
		/*To enter Subject*/
		driver.findElement(By.id("subject")).sendKeys(fib.getExcelData("Exitletter", 1, 14));
		
		/*To enter Content*/
		driver.findElement(By.id("content")).sendKeys(fib.getExcelData("Exitletter", 1, 15));
		
		/*To upload file*/
	    WebElement fileupload = driver.findElement(By.id("myInput"));
	    fileupload.sendKeys(fib.getExcelData("Exitletter", 1, 16));
