...
public class EditITPolicyLetter {
	...
	static Logger logger = Logger.getLogger(EditITPolicyLetter.class.getName());
	public static void main(String[] args) throws InterruptedException {
        ...
        edit.sendKeys(Keys.chord(Keys.CONTROL,"a"),fib.getExcelData("ITPolicyLetter", 1, 6));
