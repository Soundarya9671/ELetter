...
public class EditSalaryRevisionLetter {
	...
	static Logger logger = Logger.getLogger(EditSalaryRevisionLetter.class.getName());
	...
	public static void main(String[] args) throws InterruptedException {
		...
		driver.findElement(By.id("employeeName")).sendKeys(Keys.chord(Keys.CONTROL, "a"),fib.getExcelData("SalaryRevisionLetter", 1, 5));
